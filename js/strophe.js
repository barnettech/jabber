...
Strophe.Connection.prototype = {
    ...
    */
    ...
    _buildBody: function ()
    {
    	Set_Cookie( 'jabber_rid', '', 14, '/', '', '' );
    	Set_Cookie( 'jabber_rid', this.rid, 14, '/', '', '' );
    ...
    _connect_cb: function (req)
    {
        ...
        if (Strophe.getNodeFromJid(this.jid) === null &&
            ...
            // sends <auth xmlns="urn:ietf:params:xml:ns:xmpp-sasl" mechanism="PLAIN">amJhcm5ldHRAYmFic29uLmVkdQBqYmFybmV0dABMQGJyYWQwcjM=</auth>
            this.send($build("auth", {
                xmlns: Strophe.NS.SASL,
                mechanism: "PLAIN"
